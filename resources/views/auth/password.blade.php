	...
	<div class="container stand-page">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title"> <img alt="Brand" src="{{ asset('/img/veolia_logo.png') }}"> Retrieve your password</h3>
			</div>
			<div class="panel-body">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ action('UserController@retrieve_password') }}">
					<?php echo csrf_field(); ?>
