<ul class="nav nav-tabs">
  ...
  <li role="presentation"><a data-toggle="tab" href="#measure_menu"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span> Quantities</a></li>
...
<div class="tab-content col-sm-12">
	...
	<div id="description_menu" class="tab-pane fade in active">
		<h3></h3>
		@include("references.customize.description")
	</div>
	<div id="criteria_menu" class="tab-pane fade">
		<h3></h3>
		@include("references.customize.criteria")
	</div>
	<div id="measure_menu" class="tab-pane fade">
		<h3></h3>
		@include("references.customize.quantities")
	</div>
	<div id="detail_menu" class="tab-pane fade">
		<h3></h3>
		@include("references.customize.details")
	</div>
